// Taken from https://github.com/asumansenol/double_edged_sword_crawler/blob/main/helpers/register_login_feature_extraction/register_login_signals.js
/**
 ...
 */
getLoginSignupControlObj = function() {
 ...
 */
getSignupLoginSignalsFromPage = function() {
 ...
 * @return {FormSignals}
 */
controlFormSignals = function(forms) {
 ...
 */
controlAnchorSignals = function(elements) {
 ...
 * @return {DivSignals}
 */
controlDivSignals = function(divElements) {
 ...
 * @return {boolean}
 */
hasResetPattern = function(pageUrl) {
 ...
 * @return {boolean}
 */
hasNewsletterPattern = function(pageUrl) {
 ...
 */
checkButtonSignals = function(elements) {
 ...
 */
controlInputSignals = function(elements) {
 ...
 * @return {LabelSignals}
 */
controlLabelSignals = function(elements) {
 ...
 */
controlHeaderSignals = function(elements) {
 ...
 */
controlCheckboxSignals = function(elements) {
 ...
 */
controlPasswordSignals = function(elements) {
 ...
 */
convertPageSignalsToVector = function(pageSignals) {
    ...
    return pageSignalResult.map((signal) => signal === true ? true : false);
}

getSignalsAndConvertToBinary = function() {
