// Taken from https://github.com/asumansenol/double_edged_sword_crawler/blob/main/helpers/register_login_feature_extraction/register_login_signals_utils.js
/**
 ...
 * @return {number}
 */
countRegex = function(regex, text) {
 ...
 * @return {boolean}
 */
attrsAndTextMatch = function(element, attrRegexes, contentRegexes) {
...
hasMatchOnLabelAriaLabelPlaceholder = function(
  element, regex) {
 ...
 * @return {boolean}
 */
hasButtonCloseToUsernameOrEmail = function(emails, usernames, button) {
 ...
 * @return {boolean}
 */
hasMatchOnText = function(regex, checkStr) {
 ...
 * @return {boolean}
 */
hasMatchInElementAttrs = function(element, regex) {
  return element &&
 ...
 * @return {boolean}
 */
isUsernameField = function(element, expr) {
  // @ts-ignore
 ...
 * @return {Element[]}
 */
getElementDescendants = function(element, selector) {
 ...
 */
getVisibleUsernameFields = function(documentBody, usernameRegexPattern) {
 ...
 * @return {number}
 */
isElementNearToAnother = function(element1, element2) {
 ...
 */
closestElementWithinElementBySelector = function(toElement, inElement, selector) {
  if (inElement) {
 ...
 * @return {boolean}
 */
closestLabelMatchesWRegexPattern = function(element, regex) {
 ...
 * @return {boolean}
 */
hasTextContentMatch = function(element, regexes) {
 ...
 * @return {boolean}
 */
hasLabelMathcesWRegexPattern = function(element, regex) {
  // @ts-ignore
 ...
 * @return {Element[]}
 */
geVisibleEmailFields = function(documentBody) {
 ...
 * @return {boolean}
 */
canFieldContainPersonalData = function(element) {
 ...
 * @return {boolean}
 */
hasMatchOnAttrs = function(element, regexes) {
 ...
 * @return {Element[]}
 */
getAllVisibleElements = function(documentBody, selector) {
 ...
 * @return {Element[]}
 */
getAllVisibleHeaders = function(documentBody) {
 ...
 * @return {Element[]}
 */
checkDivMatch = function(divElements, regex) {
 ...
 * @return {Element[]}
 */
getDivsContainingAccountCheck = function(documentBody) {
 ...
 * @return {Element[]}
 */
getAllVisibleButtons = function(documentBody) {
 ...
 * @return {boolean}
 */
hasButtonCloseToInputs = function(visibleEmailUsernameElements, button) {
